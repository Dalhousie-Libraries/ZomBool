...
init -1 python hide:
    ...
    if persistent.lang == "francais":
        config.window_title = u"ZomBool — Une histoire d'horreur"
    else:
         config.window_title = u"ZomBool — A Horror Story"
    ...
    theme.roundrect(
        ## Theme: Marker, TV, Roundrect, regal, glow, diamond, bordered, austen, 3D
        ## Color scheme: Dramatic Flesh with Modifications
        ...
        mm_root = "creepyroom animated",  

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "creepyRoom.jpg",
    ...
    config.main_menu_music = "Political Ad.mp3"
    ...
    config.say_attribute_transition = fade
...
python early:
    config.save_directory = "ZomBool-1462874322-2"
...
init python:
    ...
    build.directory_name = "ZomBool-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "ZomBool"
    ...
    build.classify('*.txt',None)  #Should remove text file from the base directory
